...
<div id="editor-base">
  {#if isCmsEditOn}
    ...
    {/await}
  {:else}
    <div class="re-load-spacer" />
  {/if}

  <button
    class="floating-button"
    on:click={toggleCmsEdit}
    class:active={isCmsEditOn}
  >
    {#if isCmsEditOn}
      <svg
        class="view-icon"
        ...
        ><path
          fill="currentColor"
          d="M8.47 8.47a.75.75 0 0 1 1.06 0L12 10.94l2.47-2.47a.75.75 0 1 1 1.06 1.06L13.06 12l2.47 2.47a.75.75 0 0 1-1.06 1.06L12 13.06l-2.47 2.47a.75.75 0 1 1-1.06-1.06L10.94 12L8.47 9.53a.75.75 0 0 1 0-1.06Z"
        /><path
          fill="currentColor"
          fill-rule="evenodd"
...
<style>
  ...
  .floating-button {
    ...
    left: 20px;
    border: none;
    background-color: hsl(197, 67%, 13%);
    color: #fff;
    border-radius: 50%;
    cursor: pointer;
    margin: 0;
    ...
    align-items: center;
    border-color: hsla(197, 67%, 24%, 0.8);
